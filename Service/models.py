...
class ServiceCenters(models.Model):
    ...
    address = models.TextField(verbose_name=_("Address"), max_length=50, blank=True, null=True)
    opening_hour = models.DateTimeField(verbose_name=_("opening_hour"), blank=True, null=True)
    ...
    state = models.CharField(verbose_name=_("State"), max_length=50, blank=True, null=True)
